          ...
          <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Pelanggan" disabled>
                </div>
                <div class="form-group">
                  <Label>Alamat</Label>
                  <input type="text" class="form-control" name="alamat" id="alamat" placeholder="Alamat" disabled>
                </div>
                <div class="form-group">
                  <Label>HP</Label>
                  <input type="text" class="form-control" name="hp" id="hp" placeholder="cth : 62xxx" disabled>
                </div>
          </div>
          <div class="col-md-6">
              <div class="form-group">
                  <Label>Meteran Lama</Label>
                  <input type="text" class="form-control" name="meteran" id="meteran" placeholder="Meteran" disabled>
                </div>
                <div class="form-group">
                  <Label>Meteran Baru</Label>
                  <input type="text" class="form-control" name="meteran_baru" id="meteran_baru" placeholder="Meteran">
                </div>
                <div class="form-group">
                  <Label>Volume</Label>
